...
public class PlayerData implements Serializable {
	...
	public PlayerRank getRank() {
		if (uuid.equals(NSPLoader.main.playermanager.getOwnerUniqueID())) {
	...
	public void setRank(PlayerRank rank) {
		if (!uuid.equals(NSPLoader.main.playermanager.getOwnerUniqueID())) {
			...
			if (player != null) {
				NSPLoader.main.playermanager.namereload(player);
				NSPLoader.main.playermanager.rankmessage(player, this);
			}
		}
	}
